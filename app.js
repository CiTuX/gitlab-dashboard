...
})(PS["Data.Foreign.Generic.EnumEncoding"] = PS["Data.Foreign.Generic.EnumEncoding"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Data_Foldable = PS["Data.Foldable"];
...
(function(exports) {
  ...
  var newtypeProjectName = new Data_Newtype.Newtype(function (n) {
      return n;
  }, ProjectName);
  var getProjects = function (v) {
      return function (v1) {
          var url = v + ("/api/v4/projects?private_token=" + (v1 + "&simple=true&per_page=20&order_by=last_activity_at"));
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(url))(function (v2) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Eq.notEq(Network_HTTP_StatusCode.eqStatusCode)(v2.status)(200))(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error("Failed to fetch projects"))))(function () {
                  var v3 = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "name";
                  }))(readforeignProjectName)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))())))(v2.response);
                  if (v3 instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error("Failed to parse projects: " + Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))(v3.value0)));
                  };
                  if (v3 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v3.value0);
                  };
                  throw new Error("Failed pattern match at Gitlab line 146, column 3 - line 149, column 36: " + [ v3.constructor.name ]);
              });
          });
      };
  };
  var genericPipelineStatus = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Gitlab line 32, column 8 - line 32, column 66: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var readForeignPipelineStatus = new Simple_JSON.ReadForeign(Data_Foreign_Generic_EnumEncoding.genericDecodeEnum(genericPipelineStatus)(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "Running";
  })))(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "Pending";
  })))(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "Success";
  })))(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      ...
      return "Canceled";
  })))(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "Skipped";
  }))))))))({
      constructorTagTransform: Data_String.toLower
  }));
  ...
  var genericJobeStatus = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Gitlab line 52, column 8 - line 52, column 57: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var readForeignJobStatus = new Simple_JSON.ReadForeign(Data_Foreign_Generic_EnumEncoding.genericDecodeEnum(genericJobeStatus)(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "JobCreated";
  })))(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      return "JobManual";
  })))(Data_Foreign_Generic_EnumEncoding.sumGenericDecodeEnum(Data_Foreign_Generic_EnumEncoding.ctorNoArgsGenericDecodeEnum(new Data_Symbol.IsSymbol(function () {
      ...
      constructorTagTransform: function ($101) {
          return Data_String.drop(3)(Data_String.toLower($101));
      }
  }));
          ...
          return function (project) {
              var setProject = function (p) {
                  return function (j) {
                      var $87 = {};
                      for (var $88 in j) {
                          if ({}.hasOwnProperty.call(j, $88)) {
                              $87[$88] = j[$88];
                          };
                      };
                      $87.project = new Data_Maybe.Just(p);
                      return $87;
                  };
              };
              var readJSDate = function (date) {
                  return Control_Monad_Eff_Unsafe.unsafePerformEff(Data_JSDate.parse(date));
              };
              var castDates = function (job) {
                  var $90 = {};
                  for (var $91 in job) {
                      if ({}.hasOwnProperty.call(job, $91)) {
                          $90[$91] = job[$91];
                      };
                  };
                  $90.created_at = readJSDate(job.created_at);
                  $90.started_at = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($102) {
                      return Data_Maybe.Just.create(readJSDate($102));
                  })(job.started_at);
                  $90.finished_at = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($103) {
                      return Data_Maybe.Just.create(readJSDate($103));
                  })(job.finished_at);
                  return $90;
              };
              var url = v + ("/api/v4/projects/" + (Data_Show.show(showProjectId)(project.id) + ("/jobs?private_token=" + (v1 + "&per_page=100"))));
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(url))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Eq.notEq(Network_HTTP_StatusCode.eqStatusCode)(v2.status)(200))(Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error("Failed to fetch jobs"))))(function () {
                      var v3 = Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "commit";
                          ...
                          return "title";
                      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))()))(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "created_at";
                          ...
                          return "status";
                      }))(readForeignPipelineStatus)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))()))(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "project";
                      }))(Simple_JSON.readMaybe(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "id";
                      }))(readforeignProjectId)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "name";
                      }))(readforeignProjectName)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())(Type_Row.rowLacks()()()(Type_Row.rowLacking))())))(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "ref";
                      ...
                      if (v3 instanceof Data_Either.Left) {
                          return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadThrowAff)(Control_Monad_Eff_Exception.error("Failed to parse jobs: " + Data_Show.show(Data_List_Types.showNonEmptyList(Data_Foreign.showForeignError))(v3.value0)));
                      };
                      if (v3 instanceof Data_Either.Right) {
                          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(setProject(project))(Data_Functor.map(Data_Functor.functorArray)(castDates)(v3.value0)));
                      };
                      throw new Error("Failed pattern match at Gitlab line 164, column 3 - line 167, column 71: " + [ v3.constructor.name ]);
                  });
              });
          };
      };
  ...
  exports["newtypeProjectName"] = newtypeProjectName;
...
(function(exports) {
  ...
  var getUniqueStages = function (jobs) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
          ...
          return v.id;
      })(Data_Array.mapMaybe(function (grp) {
          return Data_Array.last(Data_Array.sortWith(Gitlab.ordJobId)(function (v) {
              return v.id;
          })(Data_NonEmpty.fromNonEmpty(Data_Array.cons)(grp)));
      })(Data_Array.groupBy(function (a) {
          return function (b) {
              return Data_Eq.eq(Gitlab.eqJobName)(a.name)(b.name);
          };
  ...
  var makePipelineRow = function (jobs) {
      var runningTime = function (pipelineJobs) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(Data_Array.sort(Data_DateTime.ordDateTime)(Data_Array.mapMaybe(function (j) {
              return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_JSDate.toDateTime)(j.started_at);
          })(pipelineJobs))))(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(Data_Array.reverse(Data_Array.sort(Data_DateTime.ordDateTime)(Data_Array.mapMaybe(function (j) {
                  return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_JSDate.toDateTime)(j.finished_at);
              })(pipelineJobs)))))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_DateTime.diff(Data_Time_Duration.durationMilliseconds)(v)(v1));
              });
          });
      };
      var jobs$prime = Data_NonEmpty.fromNonEmpty(Data_Array.cons)(jobs);
      var job = Data_NonEmpty.head(jobs);
      var defaultProject = {
          id: 0, 
          name: ""
      };
  ...
  var makeProjectRows = function (jobs) {
      return Data_Functor.map(Data_Functor.functorArray)(makePipelineRow)(Data_Array.groupBy(function (a) {
          return function (b) {
              return Data_Eq.eq(Gitlab.eqPipelineId)((function (v) {
...
(function(exports) {
  ...
  var rowColor = function (v) {
      if (v instanceof Gitlab.Running) {
          return "bg-primary";
      };
      if (v instanceof Gitlab.Pending) {
          return "bg-info";
      };
      if (v instanceof Gitlab.Success) {
          return "bg-success";
      };
      if (v instanceof Gitlab.Failed) {
          return "bg-danger";
      };
      if (v instanceof Gitlab.Canceled) {
          return "bg-warning";
      };
      if (v instanceof Gitlab.Skipped) {
          return "bg-none";
      };
      throw new Error("Failed pattern match at Dashboard.View line 156, column 3 - line 164, column 1: " + [ v.constructor.name ]);
  };
  var iconName = function (v) {
      if (v instanceof Calendar) {
          return "calendar";
      };
      if (v instanceof CircleO) {
          return "circle-o";
      };
      if (v instanceof ClockO) {
          return "clock-o";
      };
      if (v instanceof Code) {
          return "code";
      };
      if (v instanceof CodeFork) {
          return "code-fork";
      };
      if (v instanceof Stack) {
          return "stack";
      };
      if (v instanceof DotCircleO) {
          return "dot-circle-o";
      };
      if (v instanceof UserCircleO) {
          return "user-circle-o";
      };
      if (v instanceof Refresh) {
          return "refresh";
      };
      if (v instanceof QuestionCircleO) {
          return "question-circle-o";
      };
      if (v instanceof CheckCircleO) {
          return "check-circle-o";
      };
      if (v instanceof TimesCircleO) {
          return "times-circle-o";
      };
      if (v instanceof StopCircleO) {
          return "stop-circle-o";
      };
      if (v instanceof ArrowCircleORight) {
          return "arrow-circle-o-right";
      };
      throw new Error("Failed pattern match at Dashboard.View line 51, column 3 - line 67, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fontAwesome = function (icon) {
      return function (moreClasses) {
          return Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(fontAwesomeClasses(icon))(moreClasses)), Halogen_HTML_CSS.style(CSS_Geometry.margin(CSS_Size.px(0.0))(CSS_Size.px(3.0))(CSS_Size.px(0.0))(CSS_Size.px(3.0))) ])([  ]);
      };
  };
  var formatTimes = function (v) {
      ...
      })) ])([ fontAwesome(ClockO.value)([  ]), Halogen_HTML_Core.text(" " + Moment.formatMillis(v.duration)), Halogen_HTML_Elements.br_, fontAwesome(Calendar.value)([  ]), Halogen_HTML_Core.text(" " + Moment.fromNow(v.when)) ]);
  };
  var statusIcon = function (v) {
      if (v instanceof Gitlab.JobRunning) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(fontAwesomeClasses(Stack.value)) ])([ fontAwesome(CircleO.value)([ "fa-stack-2x" ]), fontAwesome(Refresh.value)([ "fa-stack-1x", "fa-inverse" ]) ]);
      };
      return fontAwesome((function () {
          if (v instanceof Gitlab.JobCreated) {
              return DotCircleO.value;
          };
          if (v instanceof Gitlab.JobManual) {
              return UserCircleO.value;
          };
          if (v instanceof Gitlab.JobRunning) {
              return Refresh.value;
          };
          if (v instanceof Gitlab.JobPending) {
              return QuestionCircleO.value;
          };
          if (v instanceof Gitlab.JobSuccess) {
              return CheckCircleO.value;
          };
          if (v instanceof Gitlab.JobFailed) {
              return TimesCircleO.value;
          };
          if (v instanceof Gitlab.JobCanceled) {
              return StopCircleO.value;
          };
          if (v instanceof Gitlab.JobSkipped) {
              return ArrowCircleORight.value;
          };
          throw new Error("Failed pattern match at Dashboard.View line 89, column 5 - line 97, column 39: " + [ v.constructor.name ]);
      })())(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "fa-2x", "align-middle" ]));
  };
  ...
  var formatCommit = function (v) {
      ...
      return Halogen_HTML_Elements.div([  ])([ authorImage(v.authorImg), divider, fontAwesome(CodeFork.value)([  ]), Halogen_HTML_Elements.b_([ Halogen_HTML_Core.text(" " + v.branch) ]), divider, fontAwesome(Code.value)([  ]), Halogen_HTML_Core.text(" " + v.hash), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "truncate" ]) ])([ Halogen_HTML_Core.text(v.commitTitle) ]) ]);
  };
  var formatPipeline = function (pipeline) {
      ...
      var cells = [ [ formatStatus(pipeline) ], [ Halogen_HTML_Elements.b_([ Halogen_HTML_Core.text(Data_Newtype.unwrap(Gitlab.newtypeProjectName)(pipeline.project.name)) ]) ], [ formatCommit(pipeline.commit) ], Data_Functor.map(Data_Functor.functorArray)(statusIcon)(pipeline.stages), [ formatTimes({
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];        
  var UpsertProjectPipelines = (function () {
      function UpsertProjectPipelines(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpsertProjectPipelines.create = function (value0) {
          return function (value1) {
              return new UpsertProjectPipelines(value0, value1);
          };
      };
      return UpsertProjectPipelines;
  })();
  var ui = (function () {
      ...
      var initialState = [  ];
      var $$eval = function (v) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function ($6) {
              return Data_Array.take(40)(Data_Array.reverse(Data_Array.sortWith(Data_DateTime.ordDateTime)(Dashboard_Model.createdDateTime)((function (v1) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value0)(v1);
  ...
  exports["UpsertProjectPipelines"] = UpsertProjectPipelines;
  exports["ui"] = ui;
...
(function(exports) {
  ...
  var pollProjects = function (baseUrl) {
      return function (token) {
          return function (query) {
              var fetchJobs = function (projects) {
                  var v = Data_Array.uncons(projects);
                  if (v instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                  };
                  if (v instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Fetching Jobs for Project with id: " + Global_Unsafe.unsafeStringify(v.value0.head.id)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Gitlab.getJobs(baseUrl)(token)(v.value0.head))(function (v1) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(query(Halogen_Query.action(Dashboard_Component.UpsertProjectPipelines.create(Dashboard_Model.makeProjectRows(v1)))))(function (v2) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(1000.0))(function () {
                                      return fetchJobs(v.value0.tail);
                                  });
                              });
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Main line 40, column 26 - line 50, column 21: " + [ v.constructor.name ]);
              };
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Fetching list of projects..."))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Gitlab.getProjects(baseUrl)(token))(function (v) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(fetchJobs(v))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(30000.0))(function () {
                              return Data_Functor["void"](Control_Monad_Aff.functorAff)(pollProjects(baseUrl)(token)(query));
                          });
                      });
                  });
              });
  ...
  var main = function __do() {
      var v = Data_Functor.map(Control_Monad_Eff.functorEff)(Gitlab.Token)(URLSearchParams.get("private_token"))();
      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Gitlab.BaseUrl)(URLSearchParams.get("gitlab_url"))();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Dashboard_Component.ui)(Data_Unit.unit)(v2))(function (v3) {
              return pollProjects(v1)(v)(v3.query);
          });
      }))();
  };
  exports["main"] = main;
