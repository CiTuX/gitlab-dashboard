...
(function(exports) {
  ...
  var getUniqueStages = function (jobs) {
      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
          ...
          return v.id;
      })(Data_Array.mapMaybe(Data_Foldable.maximumBy(Data_NonEmpty.foldableNonEmpty(Data_Foldable.foldableArray))(Data_Ord.comparing(Gitlab.ordJobId)(function (v) {
          return v.id;
...
(function(exports) {
  ...
  var formatPipeline = function (pipeline) {
      var rowColor = function (status) {
          ...
          throw new Error("Failed pattern match at Dashboard.View line 129, column 7 - line 135, column 38: " + [ status.constructor.name ]);
      };
...
(function(exports) {
  ...
  var ui = function (v) {
      ...
      var initialState = [  ];
      var getProjects = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Fetching list of projects..."))(function () {
          return Gitlab.getProjects(v.baseUrl)(v.token);
      });
      var getJobs = function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Fetching Jobs for Project with id: " + Data_Show.show(Data_Show.showInt)(v1.id)))(function () {
              return Gitlab.getJobs(v.baseUrl)(v.token)(v1);
          });
      };
      var $$eval = function (v1) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v1.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getProjects))(function (v2) {
              return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(v2)(function (project) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(1000.0))(function () {
...
(function(exports) {
  ...
  var pollProjects = function (io) {
      return Control_Monad_Rec_Class.forever(Control_Monad_Aff.monadRecAff)(Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff)(io.query(Halogen_Query.action(Dashboard_Component.FetchProjects.create)))(function (error) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Polling failed with error: " + Control_Monad_Eff_Exception.message(error)))(function () {
              return Control_Monad_Aff.delay(5000.0);
          });
      }));
  };
  var main = function __do() {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Dashboard_Component.ui(config))(Data_Unit.unit)(v2))(function (v3) {
